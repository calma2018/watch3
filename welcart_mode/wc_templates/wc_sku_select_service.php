					...
					<div class="field">
						...
						<?php if ( 0 < (int) $usces_item['dlseller_interval'] ) : ?>
							<tr>
								...
								<td><?php echo wp_kses_post( $usces_item['dlseller_interval'] ); ?><?php esc_html_e( 'month (Automatic Updates)', 'welcart_mode' ); ?></td>
							</tr>
						<?php endif; ?>
						</table>
					</div>
						...
						<div class="skuform cf item-info" id="skuform">
							...
							<div class="is-cart">
								...
								<div class="field_price">
									...
									<?php endif; ?>
									<span class="sell_price ss_price"><?php usces_the_itemPriceCr(); ?></span><?php usces_guid_tax(); ?><span class="wcss_loading"></span>
								</div>
