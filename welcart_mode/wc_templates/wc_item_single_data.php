		...
		<article <?php post_class( $class ); ?> id="post-<?php the_ID(); ?>">
			...
			<section class="is-product">
				...
				<div class="add-to-cart">
					...
					<table class="dlseller data">
						<tr><th><?php esc_html_e( 'dlValidity(days)', 'dlseller' ); ?></th><td><?php echo esc_html( usces_dlseller_validity( $post ) ); ?></td></tr>
						<tr><th><?php esc_html_e( 'File Name', 'dlseller' ); ?></th><td><?php echo esc_html( usces_dlseller_filename( $post ) ); ?></td></tr>
						<tr><th><?php esc_html_e( 'Release Date', 'dlseller' ); ?></th><td><?php echo esc_html( usces_get_itemMeta( '_dlseller_date', $post->ID, 'return' ) ); ?></td></tr>
						<tr><th><?php esc_html_e( 'Version', 'dlseller' ); ?></th><td><?php echo esc_html( usces_get_itemMeta( '_dlseller_version', $post->ID, 'return' ) ); ?></td></tr>
						<tr><th><?php esc_html_e( 'Author', 'dlseller' ); ?></th><td><?php echo esc_html( usces_get_itemMeta( '_dlseller_author', $post->ID, 'return' ) ); ?></td></tr>
					</table>
					...
					<?php if ( 'continue' === dlseller_get_charging_type( $post->ID ) ) : ?>
						...
						<div class="field">
							<table class="dlseller charging">
								<tr><th><?php esc_html_e( 'First Withdrawal Date', 'dlseller' ); ?></th><td><?php echo wp_kses_post( dlseller_first_charging( $post->ID ) ); ?></td></tr>
							<?php if ( 0 < (int) $usces_item['dlseller_interval'] ) : ?>
								<tr><th><?php esc_html_e( 'Contract Period', 'dlseller' ); ?></th><td><?php echo wp_kses_post( $usces_item['dlseller_interval'] ); ?><?php esc_html_e( 'month (Automatic Updates)', 'welcart_mode' ); ?></td></tr>
							<?php endif; ?>
							</table>
						</div>
					<?php endif; ?>
