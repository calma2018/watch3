...
<article class="post" id="wc_member_mda">
	<div class="column980 member-page">
		<header class="entry-member-header">
			...
			<h1 class="member_page_title">配送先登録</h1>
		</header>
		<div id="memberpages">
			<div id="memberinfo">
				<div class="user-info">
				...
				<div class="msa_area">
					...
					if ( isset( $_GET['mda_backurl'] ) && wp_verify_nonce( $nonce, WCEX_DA_Member_Page::WPNONCE ) ) :
						...
						<div class="allocation_dialog_exp"><?php echo wp_kses_post( __( '1. Click "Register New Shipping Address" to go to the new registration screen. <br>2. When you have finished entering your name and address, press "Register". <br>3. When you have completed your registration, press "Return to Shipping Address Settings" at the bottom of the screen. <br><br>You cannot delete a shipping address that is marked as (Yourself). To change or delete a registered shipping address, select a shipping address other than (you) from "Select a shipping address to edit".', 'wcexda' ) ); ?></div>
					<?php else : ?>
						<div class="allocation_dialog_exp"><?php echo wp_kses_post( __( '1. Click "Register New Shipping Address" to go to the new registration screen. <br>2. When you have finished entering your name and address, press "Register". <br><br>You cannot delete a shipping address that is marked as (Yourself). To change or delete a registered shipping address, select a shipping address other than (you) from "Select a shipping address to edit".', 'wcexda' ) ); ?></div>
					<?php endif; ?>
					...
					<div class="msa_field_block">
						...
						<div class="msa_field">
							...
							<span class="member_name"><?php esc_html_e( 'Family name', 'wcexda' ); ?></span><input id="msa_name" name="msa_name" type="text" />
							<span class="member_name"><?php esc_html_e( 'First name', 'wcexda' ); ?></span><input id="msa_name2" name="msa_name2" type="text" />
